...
class ReviewsController extends Controller
{
    ...
    {
        $this->appManger = new ResourceAppManager(Review::class, 'home-page-reviews');
    }
    ...
    public function create()
    {
        return $this->appManger
            ...
            ->addFileInput('Thumbnail Image', 'image', note: '* (500x500)', className: 'col-10')
            ->addInput('Ratings', 'rating', note: '* (average rating like 4.9)', className: 'col-2')
    ...
    public function store(Request $request)
    {
        return $this->appManger
            ...
            ->addData('rating', required: 'required|max:5')
            ->addData('serial')
    ...
    public function edit(string $id)
    {
        ...
        return $app
            ...
            ->addFileInput('Thumbnail Image', 'image', note: '* (500x500)', className: 'col-10', editable: true)
            ->addInput('Ratings', 'rating', note: '* (average ratings)', className: 'col-2', editable: true)

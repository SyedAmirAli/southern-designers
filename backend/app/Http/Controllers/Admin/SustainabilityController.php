...
class SustainabilityController extends Controller
{
    ...
    {
        $this->appManager = new ResourceAppManager(SinglePageData::class, 'sustainability', modelDataReference: SinglePageDataKeyManager::SUSTAINABILITY_PAGE);
    }
    /**
    ...
    public function index()
    {
        ...
        return $this->appManager->addPageData('title', 'Sustainability Page Static Items Setup')
            ->addInput(
            ...
            ->addInput(
                ...
                note: '*',
                className: 'col-6',
                value: isset($contents['video_title']) ? $contents['video_title'] : ''
            )
            ->addInput(
                'Video Heading',
                'video_heading',
                note: '*',
                className: 'col-6',
                value: isset($contents['video_heading']) ? $contents['video_heading'] : ''
            )
            // mission
    ...
    public function store(Request $request)
    {
        return $this->appManager
            ...
            ->addJsonData('contents', 'video_title')
            ->addJsonData('contents', 'video_heading')

...
class OthersServicesController extends Controller

{
    ...
    {
        $this->appManger = new ResourceAppManager(OthersService::class, 'home-page-others-services');
    }
    ...
    public function index()
    {
        return $this->appManger
            ...
            ->addDataTablesColumn('Main Icon', 'icon')
    ...
    public function create()
    {
        return $this->appManger
            ...
            ->addInput('Main Icon', 'icon', note: '* Font Awesome v6 Free Icons.')
    ...
    public function store(Request $request)
    {
        return $this->appManger
            ...
            ->addData('serial')
            ->addData('icon', required: 'required|max:100')
            ->addCreator()
            ->storeData();
    }
    ...
    public function edit(string $id)
    {
        ...
        return $app
            ...
            ->addInput('Main Icon', 'icon', note: '* Font Awesome v6 Free Icons.', editable: true)
